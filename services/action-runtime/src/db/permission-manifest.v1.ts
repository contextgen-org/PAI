...
export const ACTION_RUNTIME_REPOSITORY_CONTRACT_V1 =
  defineOwnerRepositoryContractV1({
    ...
    ownerFunctionSignatureV1({
      ...
      writes_tables: [
        "runtime_runs", "runtime_policy_input_artifacts", "runtime_policy_snapshots",
        "tool_invocations", "runtime_control_signals", "runtime_control_tombstones",
        "runtime_permissions", "runtime_artifacts", "runtime_events",
        "runtime_event_inbox", "runtime_event_outbox",
      ],
      returns: "jsonb",
    }),
    ownerFunctionSignatureV1({

...
export const TRIGGER_PROCESSOR_REPOSITORY_CONTRACT_V1 =
  defineOwnerRepositoryContractV1({
    ...
    },
    {
      ...
      select_columns: ["id","trigger_id","workspace_id","bot_id","owner_agent_id","deployment_environment","release_channel","admission_time","phase","status","wait_reason","current_reason_code","state_version","current_runtime_run_id","runtime_policy_created_at","runtime_policy_expires_at","current_snapshot_id","inherited_from_process_id","blocked_by_process_id","canonical_process_id","preempted_by_process_id","successor_process_id","superseded_by_process_id","preempt_commit_result","preempt_isolation_proof_ref","merged_into_process_id","merged_into_queue_item_id","terminal_reason","terminal_outcome","terminal_outcome_finalized_at","snapshot_transfer_ref","boundary_system_event_ref","canonical_reason_code","observation_finalized","meta_enqueue_reason","cancel_requested_at","cancellation_status","cancel_reason_code","cancel_actor_principal_id","cancel_actor_role","runtime_cancel_signal_id","cancellation_isolation_status","cancelled_at","cooldown_until","snapshot_retention_until","context_snapshot_ref","context_snapshot_version","context_snapshot_hash","context_snapshot_retention_until","intent_ref","created_at","updated_at"],
      insert_columns: [],
      update_columns: [],
      delete_allowed: false,
      writer_kind: "state_transition",
    ...
    ownerFunctionSignatureV1({
      ...
      reads_tables: ["trigger_processes", "trigger_process_cancel_requests", "runtime_start_reservations", "bot_foreground_slots", "bots", "bot_permission_bindings"],
      writes_tables: ["trigger_process_cancel_requests", "trigger_processes", "trigger_process_meta_projections", "trigger_process_transitions", "trigger_command_outbox", "trigger_event_outbox"],
      effects: [
        { table_name: "trigger_process_cancel_requests", operation: "append", concurrency_control: "idempotency_key" },
        { table_name: "trigger_process_cancel_requests", operation: "append", concurrency_control: "advisory_identity_lock", advisory_lock: RUNTIME_START_PROCESS_LOCK_V1 },
        { table_name: "trigger_processes", operation: "transition", concurrency_control: "database_row_lock" },
  ...
  const coupledWriters = [
    ...
    },
    {
      ...
      effects: [
        ...
        "trigger_process_cancel_requests:append:advisory_identity_lock",
        "trigger_processes:transition:database_row_lock",
